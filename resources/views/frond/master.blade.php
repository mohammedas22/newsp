...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{asset('frond/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="{{asset('frond/css/modern-business.css')}}" rel="stylesheet">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('news.all-news')}}">{{$category->name}}</a>
                </li>
                @endforeach
                <li class="nav-item">
...
<script src="{{asset('frond/vendor/jquery/jquery.min.js')}}"></script>
